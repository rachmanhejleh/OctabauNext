...
export default async function ProjectDetail({
    ...
    return (
        <div>
            {/* Hero Section */}
            <section style={{ position: 'relative', backgroundColor: '#000000', color: 'var(--primary-foreground)', padding: '8rem 0 5rem 0', overflow: 'hidden' }}>
                <div style={{ position: 'absolute', top: 0, right: 0, bottom: 0, left: 0, zIndex: 0, opacity: 0.4 }}>
                    <Image
                        src={project.image}
                        alt={project.title}
                        fill
